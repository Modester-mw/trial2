...
def play_sound():
    playsound.playsound('/Users/foundation/Desktop/real-time-violence-detection/data/buzz.mp3')
...
def write_label(frame, prediction):    
    ...
    if prediction['label'].lower() == 'violence':  # check if label is 'violence' 
        borderColor =  (36,28,236)  
        threading.Thread(target=play_sound).start()  # start a new thread to play the sound
